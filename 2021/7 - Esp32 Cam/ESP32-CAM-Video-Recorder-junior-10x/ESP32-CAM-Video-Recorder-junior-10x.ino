...
#define WDT_TIMEOUT 300      //Tempo Limite para que o watchdog reset o espcam (300s = 5min)

static const char vernum[] = "v10";
static const char devname[] = "desklens";         // name of your camera for mDNS, Router, and filenames

#define IncludeInternet 1                         // para ativar a conexão wifi/internet defina o valor como 1, e insira o ssid e a senha da rede wifi. Para desativar defina como 0.             
//const char* ssid = "FOGUETE";
//const char* password = "insert45";
const char* ssid = "SOLARIS_BOAT";
...
int c1_framesize = 9;               //  10 UXGA, 9 SXGA, 7 SVGA, 6 VGA, 5 CIF
...
int c1_avi_length = 120;             // Tempo do vídeo em segundos -- 90 seg = 1 minuto e meio 
...
static esp_err_t config_camera() {
  ...
  */
  ...
  config.jpeg_quality = 8;  // 1 to 63 - smaller number is higher quality and more data - must be lower rhat the quality parameter at the top
  config.fb_count = 7;
...
static esp_err_t end_avi() {
  ...
  if (frame_cnt <  10 ) {
    ...
    esp_task_wdt_reset();               //reseta o timer do watchdog
...
IPAddress WifiIP        (192, 168, 0, 156);
//IPAddress WifiIP        (192, 168, 0, 154);
...
//IPAddress WifiIP        (192, 168, 1, 160);
